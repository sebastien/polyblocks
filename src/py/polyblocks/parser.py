...
from .blocks import LineBlock, DateBlock, ListBlock
...
class Mapping:
	...
	BLOCKS = {
		"@title"    : LineBlock.As("title"),
		"@subtitle" : LineBlock.As("subtitle"),
		"@date"     : DateBlock,
		"@created"  : DateBlock.As("created"),
		"@updated"  : DateBlock.As("updated"),
		"@tags"     : ListBlock.As("tags"),
	}
